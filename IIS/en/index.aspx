...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.5.3, mkdocs-material-9.5.18">
        ...
        <title>WELCOME👋 - PadelMatch Docs</title>
...
<p>Documentation in --&gt; <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ">APIS</a>.</p>
</div>
<h2 id="welcome-to-autopadels-rest-api">Welcome to AutoPadel's REST API<a class="headerlink" href="#welcome-to-autopadels-rest-api" title="Permanent link">&para;</a></h2>
<p>We are glad to have you here! In our developer center you will find everything you need to interact with our platform.</p>
<p>Our Endpoints will return metadata in Json format. 🎉</p>
<p>All requests are validated with an API key. You can get it by talking to our support (Coming soon integration to get Api Key manually).</p>
<p>We try to keep the documentation as clear and simple as possible. Therefore, you can test our Endpoints with your own API key, see the response code directly, etc.</p>
<div class="admonition tip inline end">
<p class="admonition-title">Tip</p>
<p class="annotate">this is an annotate: (1)  you can open it!</p>
<ol>
...
<p>Missing endpoints? Send us a message to soporte@autopadel.com ✌️</p>
