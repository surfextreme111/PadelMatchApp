...
<html lang="es" class="no-js">
  <head>
      ...
      <meta name="generator" content="mkdocs-1.5.3, mkdocs-material-9.5.18">
        ...
        <title>APIInterna - PadelMatch Docs</title>
...
<p class="admonition-title">PadelMatch</p>
...
<a id="__codelineno-4-2" name="__codelineno-4-2" href="#__codelineno-4-2"></a>    public int IdClub { get; set; }
<a id="__codelineno-4-3" name="__codelineno-4-3" href="#__codelineno-4-3"></a>    public int RefLocal { get; set; }
<a id="__codelineno-4-4" name="__codelineno-4-4" href="#__codelineno-4-4"></a>    public int CantidadJugadores { get; set; }
<a id="__codelineno-4-5" name="__codelineno-4-5" href="#__codelineno-4-5"></a>    public PistaTipo Tipo { get; set; } // Enumeración PistaTipo para el tipo de pista
<a id="__codelineno-4-6" name="__codelineno-4-6" href="#__codelineno-4-6"></a>    public PistaUbi Ubicacion { get; set; } // Enumeración PistaUbi para la ubicación de la pista
<a id="__codelineno-4-7" name="__codelineno-4-7" href="#__codelineno-4-7"></a>    public int Reserva { get; set; }
<a id="__codelineno-4-8" name="__codelineno-4-8" href="#__codelineno-4-8"></a>    public string Material { get; set; }
...
<a id="__codelineno-5-8" name="__codelineno-5-8" href="#__codelineno-5-8"></a>    public boolean permitecancelacion { get; set; }
...
<p>Se permitirá la cancelación de una una reserva hasta 2horas antes de la partida que se pondrá  y ya no se podrán anular reservas y el importe pagado no se devolverá</p>
...
<a id="__codelineno-6-2" name="__codelineno-6-2" href="#__codelineno-6-2"></a>    public int idusuario { get; set; }
<a id="__codelineno-6-3" name="__codelineno-6-3" href="#__codelineno-6-3"></a>    public string usuario { get; set; }
<a id="__codelineno-6-4" name="__codelineno-6-4" href="#__codelineno-6-4"></a>    public string mail { get; set; }
<a id="__codelineno-6-5" name="__codelineno-6-5" href="#__codelineno-6-5"></a>    public string contraseña { get; set; }
<a id="__codelineno-6-6" name="__codelineno-6-6" href="#__codelineno-6-6"></a>    public int nivel { get; set; }
<a id="__codelineno-6-7" name="__codelineno-6-7" href="#__codelineno-6-7"></a>    public string foto { get; set; }
<a id="__codelineno-6-8" name="__codelineno-6-8" href="#__codelineno-6-8"></a>    public int victorias { get; set; }
<a id="__codelineno-6-9" name="__codelineno-6-9" href="#__codelineno-6-9"></a>    public int derrotas { get; set; }
...
<a id="__codelineno-7-2" name="__codelineno-7-2" href="#__codelineno-7-2"></a>    public int idclub { get; set; }
...
<a id="__codelineno-7-5" name="__codelineno-7-5" href="#__codelineno-7-5"></a>    public string descripción { get; set; }
<a id="__codelineno-7-6" name="__codelineno-7-6" href="#__codelineno-7-6"></a>    public string idpistas { get; set; }
<a id="__codelineno-7-7" name="__codelineno-7-7" href="#__codelineno-7-7"></a>    public int idusuariocreador { get; set; }
<a id="__codelineno-7-8" name="__codelineno-7-8" href="#__codelineno-7-8"></a>    public datetime fechain { get; set; }
<a id="__codelineno-7-9" name="__codelineno-7-9" href="#__codelineno-7-9"></a>}
</code></pre></div>
<h3 id="reservas">Reservas<a class="headerlink" href="#reservas" title="Permanent link">&para;</a></h3>
<div class="admonition info">
<p class="admonition-title">Info</p>
</div>
<p>ID_Reserva: Un identificador único para cada reserva (clave primaria).
  ...
  IdClub: club al cual pertenece la reserva</p>
